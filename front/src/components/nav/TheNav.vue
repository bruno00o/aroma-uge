...
<template>
  <nav>
    <ul>
      <li>
        <RouterLink :to="{ name: 'home' }" aria-label="Accueil">
      ...
      <li v-if="studentStore.getStudentApprenticeship">
        <RouterLink to="/apprenticeship" aria-label="Apprentissage">
      ...
      <li>
        <RouterLink to="/university" aria-label="Université">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
      ...
      <li>
        <RouterLink to="/friends" aria-label="Amis">
          <div>
            ...
            <!-- <span v-if="requests.length > 0 && show" class="requests-banner">{{
              requests.length
            }}</span> -->
          </div>
          <p>Amis</p>
      ...
      <li>
        <RouterLink :to="{ name: 'settings' }" aria-label="Paramètres">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
